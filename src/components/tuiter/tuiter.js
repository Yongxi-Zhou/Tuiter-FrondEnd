...
const links = [
  {
    label: "Tuiter",
    expect: { textOnScreen: "Home Screen" },
    icon: "fa-square-t",
    path: "/tuiter",
  },
  {
  ...
  {
    label: "Explore",
    expect: { textOnScreen: "Explore Screen" },
    icon: "fa-hashtag",
    path: "/explore",
  },
  {
    label: "Notifications",
    expect: { textOnScreen: "Notifications Screen" },
    icon: "fa-bell",
    path: "/notifications",
  },
  {
    label: "Messages",
    expect: { textOnScreen: "Messages Screen" },
    icon: "fa-envelope",
    path: "/messages",
  },
  {
    label: "Bookmarks",
    expect: { textOnScreen: "Bookmarks Screen" },
    icon: "fa-bookmark",
    path: "/bookmarks",
  },
  {
    label: "Lists",
    expect: { textOnScreen: "Lists Screen" },
    icon: "fa-list",
    path: "/lists",
  },
  {
    label: "Profile",
    expect: { textOnScreen: "Edit Profile" },
    icon: "fa-user",
    path: "/profile",
  },
  {
    label: "More",
    expect: { textOnScreen: "More Screen" },
    icon: "fa-circle-ellipsis",
    path: "/more",
  },
  {
    label: "Login",
    expect: { textOnScreen: "ellenripley" },
    icon: "fa-user",
    path: "/login",
  },
];
